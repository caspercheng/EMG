...
<h3><center>預計生產明細</center></h3>

<cfquery name="MOCTA" datasource="#SESSION.COMPANY#" result="result1">
    SELECT TA010,TA001,TA002,TA006,TA034,TA035,TA012,TA007,TA015,TA017
    FROM MOCTA
