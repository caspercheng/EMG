...
<cfif  NOT IsDefined("FORM.PF002")> <cfset #FORM.PF002#="">	</cfif> 
...
<cfquery name="BIMPF_CHECK" datasource="PKOOL">
     SELECT *
	 FROM BIMPF
	 WHERE PF001 = '#TRIM(FORM.PF001)#'
	      AND PF002 = '#FORM.PF002#'
</cfquery>

<cfif #BIMPF_CHECK.recordcount# eq 0 and #FORM.PF002# gt "">
	...
	<cfquery name="BIMPH_INSERT" datasource="PKOOL">
		...
		VALUES('#FORM.PF001#','#FORM.PF002#','#SESSION.COMPANY#')
	</cfquery>
