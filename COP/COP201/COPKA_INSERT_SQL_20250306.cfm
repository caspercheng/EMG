...
--->	
	...
	<cfloop query="COPKA">
		...
		<cfloop query="COPTD">
			...
			<cfif #KA013# GT 0 AND #KA016# GT 0>
				<cfif #KA016#-#KA013# gt -1 and #KA016#-#KA013# lt 1 > <!---尾款-訂金    金額很小時--->
					<cfset aa=0>
				<cfelse>
					<cfif #KA016#-#KA013#-#KA008# LTe 1.5 AND #KA016#-#KA013#-#KA008# GTE -1.5> <!---尾款-訂金-原訂單金額    金額很小時--->
						<cfset aa=#KA008#><!---訂單金額--->
					<cfelse>
						<cfset aa=#KA016#-#KA013#><!---訂單金額--->
					</cfif>
				</cfif>
			<cfelse>
